...
/**
 * 관리자 메뉴 공지사항(notice) 요청처리 담당 컨트롤러<br/>
 * 공지사항 List 관련 요청은 ListController에서 공통으로 처리함<br/>
 * <br/>
 * @author roscoe
 *
 */
...
public class NoticeController {
	...
	public String noticeWrite(@RequestParam(required=false) Integer num, Model model) { 
		...
		if(num == null) {
			model.addAttribute("noticeRecord", new BoardRecord()); // SessionAttributes의 record를 초기화한다.
