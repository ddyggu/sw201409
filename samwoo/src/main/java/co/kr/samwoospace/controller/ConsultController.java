...
/**
 * 관리자 메뉴 고객문의(consult) 요청처리 담당 컨트롤러<br/>
 * 고객문의 List 관련 요청은 ListController에서 공통으로 처리함<br/>
 * <br/>
 * @author roscoe
 *
 */
...
public class ConsultController {
	...
	private static final String insert_s_msg = "고객문의 답변등록이 완료되었습니다.";
	private static final String update_s_msg = "고객문의 답변이 완료되었습니다.";
