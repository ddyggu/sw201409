    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/admin/FileUpload'; 	//upload URL
	...
	function onAjaxError (){
		alert("업로드 오류가 발생하였습니다. - ajax error");
	}
 	...
 	function callFileUploader () {
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/admin/editorUpload',	
 	        sCallback : '/WEB-INF/views/se_editor/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
