		...
		<script>
			...
			$(function(){
				...
				$('.btn_list').click(function(e){
					location.href="/project?division="+division+"&category="+category+"&viewType=list";
				});
				$('a[href=#tabs-1]').click(function() {
					location.href="/project?division="+division+"&category=All";
				});
				$('a[href=#tabs-2]').click(function() {
					location.href="/project?division="+division+"&category=RD";
				});
				$('a[href=#tabs-3]').click(function() {
					location.href="/project?division="+division+"&category=EDLA";
				});
				$('a[href=#tabs-4]').click(function() {
					location.href="/project?division="+division+"&category=MEWE";
				});
				$('a[href=#tabs-5]').click(function() {
					location.href="/project?division="+division+"&category=OF";
				});
				$('a[href=#tabs-6]').click(function() {
					location.href="/project?division="+division+"&category=CA";
				});
				$('a[href=#tabs-7]').click(function() {
					location.href="/project?division="+division+"&category=MICO";
				});
				$('a[href=#tabs-8]').click(function() {
					location.href="/project?division="+division+"&category=ETC";
				});
			});
		</script>
