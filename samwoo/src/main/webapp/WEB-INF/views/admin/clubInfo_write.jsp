...
<div id="wrap">
		...
		<form name="clubInfoForm" id="clubInfoForm" action="/admin/clubInfoWrite" method="post" enctype="multipart/form-data" onsubmit="return submitContents(this);">
		<table class="aborad01_write">
			...
			<tr>
				<th>동호회 이름</th>
				<td><input type="text" name="clubname" class="ainp04" value="${clubInfoRecord.clubname}"/></td>
			</tr>
			<tr>
				<th>대상</th>
				<td><input type="text" name="targetGroup" class="ainp04" value="${clubInfoRecord.targetGroup}"/></td>
			</tr>
			<tr>
				<th>활동</th>
				<td><input type="text" name="activityGroup" class="ainp04" value="${clubInfoRecord.activityGroup}"/></td>
			</tr>
			<tr>
				<th>회장</th>
				<td><input type="text" name="president" class="ainp04" value="${clubInfoRecord.president}"/></td>
			</tr>
			<tr>
				<th>소개</th>
				<td><textarea type="text" name="description" id="contents" class="ainp02">
				${clubInfoRecord.description}</textarea></td>
			</tr>
			<tr>
				<th>대표이미지</th>
				<td>
					...
					<div class="file_txt">
					<c:forEach var="file"  items="${clubInfo_fileList}">
			...
			<tr>
				<th>홈페이지 주소</th>
				<td>
					<input type="text" name="facebook" class="ainp01" onfocus="this.value==this.defaultValue?this.value='':void(0);" onblur="this.value==''?this.value=this.defaultValue:void(0);" value='${clubInfoRecord.facebook }' placeholder="동호회 홈페이지 주소"/>
				</td>
			</tr>
		...
		<div class="btn_wrap">
			...
			<a href="/admin/clubInfo"><img src="/admin/img/btn_cancle.gif" /></a>
		</div>
