...
<div id="wrap">
			...
			<p align="right"><a href="/admin/noticeWrite""><img src="/admin/img/btn_apply.gif"></a></p>
			...
			<table class="aborad01">
				...
				<c:forEach var="noticeRecord"  items="${noticeList}" >
				<tr class="onc">
					<td><input type="checkbox" name="boardNum" value="notice&${noticeRecord.num}"/></td>
					<td>${noticeRecord.num}</td>
					<td class="tleft"><a href="/admin/noticeView?num=${noticeRecord.num}&pageNum=${page}">${noticeRecord.title}</a></td>
					<td>${noticeRecord.date}</td>
				</tr>
				</c:forEach>
			</table>
